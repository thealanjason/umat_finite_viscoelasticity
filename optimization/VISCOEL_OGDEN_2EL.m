...
CNEQ(1,1) = C4NEQJ(1,1,1,1) + C4NEQJ_2(1,1,1,1);
CNEQ(1,2) = C4NEQJ(1,1,2,2) + C4NEQJ_2(1,1,2,2);
CNEQ(1,3) = C4NEQJ(1,1,3,3) + C4NEQJ_2(1,1,3,3);
CNEQ(1,4) = C4NEQJ(1,1,1,2) + C4NEQJ_2(1,1,1,2);
CNEQ(1,5) = C4NEQJ(1,1,1,3) + C4NEQJ_2(1,1,1,3);
CNEQ(1,6) = C4NEQJ(1,1,2,3) + C4NEQJ_2(1,1,2,3);
CNEQ(2,1) = CNEQ(1,2);
CNEQ(2,2) = C4NEQJ(2,2,2,2) + C4NEQJ_2(2,2,2,2);
CNEQ(2,3) = C4NEQJ(2,2,3,3) + C4NEQJ_2(2,2,3,3);
CNEQ(2,4) = C4NEQJ(2,2,1,2) + C4NEQJ_2(2,2,1,2);
CNEQ(2,5) = C4NEQJ(2,2,1,3) + C4NEQJ_2(2,2,1,3);
CNEQ(2,6) = C4NEQJ(2,2,2,3) + C4NEQJ_2(2,2,2,3);
CNEQ(3,1) = CNEQ(1,3);
CNEQ(3,2) = CNEQ(2,3);
CNEQ(3,3) = C4NEQJ(3,3,3,3) + C4NEQJ_2(3,3,3,3);
CNEQ(3,4) = C4NEQJ(3,3,1,2) + C4NEQJ_2(3,3,1,2);
CNEQ(3,5) = C4NEQJ(3,3,1,3) + C4NEQJ_2(3,3,1,3);
CNEQ(3,6) = C4NEQJ(3,3,2,3) + C4NEQJ_2(3,3,2,3);
CNEQ(4,1) = CNEQ(1,4);
CNEQ(4,2) = CNEQ(2,4);
CNEQ(4,3) = CNEQ(3,4);
CNEQ(4,4) = C4NEQJ(1,2,1,2) + C4NEQJ_2(1,2,1,2);
CNEQ(4,5) = C4NEQJ(1,2,1,3) + C4NEQJ_2(1,2,1,3);
CNEQ(4,6) = C4NEQJ(1,2,2,3) + C4NEQJ_2(1,2,2,3);
CNEQ(5,1) = CNEQ(1,5);
CNEQ(5,2) = CNEQ(2,5);
CNEQ(5,3) = CNEQ(3,5);
CNEQ(5,4) = CNEQ(4,5);
CNEQ(5,5) = C4NEQJ(1,3,1,3) + C4NEQJ_2(1,3,1,3);
CNEQ(5,6) = C4NEQJ(1,3,2,3) + C4NEQJ_2(1,3,2,3);
CNEQ(6,1) = CNEQ(1,6);
CNEQ(6,2) = CNEQ(2,6);
CNEQ(6,3) = CNEQ(3,6);
CNEQ(6,4) = CNEQ(4,6);
CNEQ(6,5) = CNEQ(5,6);
CNEQ(6,6) = C4NEQJ(2,3,2,3) + C4NEQJ_2(2,3,2,3);
...
STRESSTOT = SIGMANEQ + SIGMAEQ + SIGMANEQ_2;
